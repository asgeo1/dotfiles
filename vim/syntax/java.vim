...
"
" NOTE: disabled this as it was causing problems
"
...
" An m-variable
syn match javaPrivateIdent /\<m\u\w*\>/ display
hi def link javaPrivateIdent Identifier

" An m-variable
syn match javaStaticIdent /\<s\u\w*\>/ display
hi def link javaStaticIdent Identifier

" A class-like name that starts with a capital letter
syn match javaObject /\<\u\w*\>/ display
hi def link javaObject Structure

" A constant-like name in SCREAMING_CAPS
syn match javaConstant2 /\<\u[A-Z0-9_]\+\>/ display
hi def link javaConstant2 Constant

" A variable name
syn cluster javaIdentifier contains=javaPrivateIdent,javaStaticIdent,javaObject,javaConstant2
...
" An R.whatever string
syn match javaRString /\<R\.[A-Za-z0-9_.]*\>/ display
hi def link javaRString String
