...
function! NERDTreeCustomOpenSplit(node)
    call a:node.open({'split': 'h', 'reuse': g:NERDTreeCustomReuseWindows})
endfunction
...
function! NERDTreeCustomOpenVSplit(node)
    call a:node.open({'split': 'v', 'reuse': g:NERDTreeCustomReuseWindows})
endfunction
...
function! NERDTreeCustomOpenInTab(node)
    call a:node.open({'split': 't', 'reuse': g:NERDTreeCustomReuseWindows})
endfunction
...
function! NERDTreeCustomOpenInTabSilent(node)
    call a:node.open({'split': 't', 'stay': 1, 'reuse': g:NERDTreeCustomReuseWindows})
endfunction
