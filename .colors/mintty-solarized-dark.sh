echo -ne '\e]10;#657B83\a'  # Foreground -> base00  (bold yellow)
echo -ne '\e]11;#002B36\a'  # Background -> base03  (bold black)
echo -ne '\e]12;#93A1A1\a'  # Cursor -> base1       (bold cyan)
echo -ne '\e]4;0;#073642\a'   # black               (note - had to add this in myself)
