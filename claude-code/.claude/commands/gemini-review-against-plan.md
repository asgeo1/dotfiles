...
```bash
gemini "Review code changes against an implementation plan.
...
```bash
gemini "Review code at specific paths against an implementation plan.
...
- If Gemini encounters other errors, report them and ask for guidance
